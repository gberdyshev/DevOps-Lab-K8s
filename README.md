...
Также я выполнил развертывание клиент-серверного приложения с использованием манифестов и Helm, посмотрел, как выполняется обновление приложения в кластере.